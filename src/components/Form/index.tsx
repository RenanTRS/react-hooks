...
type FormProps = {
    ...
    validarCPF: (cpf: string) => {valido:boolean; texto:string;}; //Tipagem para uma função que irá receber um valor e retornar um objeto com dois valores
}

export const Form = ({dataChange, validarCPF}: FormProps) => {
